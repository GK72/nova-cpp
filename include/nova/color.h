...
public:
    ...
    [[nodiscard]]           float& set_r()  noexcept { return vec_type::m_vec[0]; }
    [[nodiscard]]           float& set_g()  noexcept { return vec_type::m_vec[1]; }
    [[nodiscard]]           float& set_b()  noexcept { return vec_type::m_vec[2]; }
    [[nodiscard]]           float& set_a()  noexcept { return vec_type::m_vec[3]; }
};
